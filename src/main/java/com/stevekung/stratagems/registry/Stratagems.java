...
public class Stratagems
{
    ...
    public static void bootstrap(BootstrapContext<Stratagem> context)
    {
        ...
        register(context, TNT, "swaswdsw", new ItemStack(Items.TNT), SpawnBombAction.spawnBomb(40), DepletedStratagemRule.defaultRule(), StratagemProperties.withReplenish(40, 60, 3, RED_COLOR, new StratagemReplenish(Optional.of(TNT_REARM), Optional.empty(), Optional.empty())));
