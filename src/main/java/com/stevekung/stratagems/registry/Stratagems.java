...
public class Stratagems
{
    ...
    {
        register(context, REINFORCE, "wsdaw", Items.RESPAWN_ANCHOR.getDescription(), new ItemStack(Items.RESPAWN_ANCHOR), ReinforceAction.reinforce(), 200, 2400, BLUE_COLOR);
        ...
        register(context, TNT, "swaswdsw", Items.TNT.getDescription(), new ItemStack(Items.TNT), SpawnBombAction.spawnBomb(40), 400, 12000, RED_COLOR);
    }
    ...
    {
        context.register(key, new Stratagem(code, name, Either.left(icon), action.build(), new StratagemProperties(incomingDuration, Optional.empty(), nextUseCooldown, beamColor)));
    }
