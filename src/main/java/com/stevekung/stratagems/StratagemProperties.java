...
public record StratagemProperties(int incomingDuration, Optional<Integer> duration, int cooldown, Optional<Integer> remainingUse, int beamColor, Optional<Boolean> canDepleted, Optional<Boolean> needThrow, Optional<StratagemReplenish> replenish)
{
    ...
    {
        return new StratagemProperties(incomingDuration, Optional.empty(), cooldown, Optional.empty(), beamColor, Optional.empty(), Optional.empty(), Optional.empty());
    }
    ...
    {
        return new StratagemProperties(incomingDuration, Optional.empty(), cooldown, Optional.of(remainingUse), beamColor, Optional.of(true), Optional.empty(), Optional.of(replenish));
    }

    public static StratagemProperties withDepleted(int incomingDuration, int cooldown, int remainingUse, int beamColor)
    {
        return new StratagemProperties(incomingDuration, Optional.empty(), cooldown, Optional.of(remainingUse), beamColor, Optional.empty(), Optional.empty(), Optional.empty());
    }
}