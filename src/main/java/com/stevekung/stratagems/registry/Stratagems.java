...
public class Stratagems
{
    ...
    public static void bootstrapTest(BootstrapContext<Stratagem> context)
    {
        ...
        register(context, TNT, "wdsd", Items.TNT, SpawnBombAction.spawnBomb(), DepletedAndRearmRule.defaultRule(), StratagemProperties.withReplenish(40, 60, 3, RED_COLOR, new StratagemReplenish(Optional.of(TNT_REARM), "tnt", Optional.empty(), Optional.empty())));
        register(context, FAST_TNT, "wdsw", new StratagemDisplay(StratagemDisplay.Type.ITEM, Optional.of(new ItemStack(Items.TNT)), Optional.empty(), Optional.empty(), false, Optional.of("F")), SpawnBombAction.spawnBomb(40), DepletedAndRearmRule.defaultRule(), StratagemProperties.withReplenish(40, 60, 3, RED_COLOR, new StratagemReplenish(Optional.of(TNT_REARM), "tnt", Optional.empty(), Optional.empty())));
        register(context, LONG_TNT, "awdw", Items.TNT, SpawnBombAction.spawnBomb(100, Blocks.DIAMOND_BLOCK.defaultBlockState()), DepletedAndRearmRule.defaultRule(), StratagemProperties.withReplenish(40, 60, 1, RED_COLOR, new StratagemReplenish(Optional.of(TNT_REARM), "tnt", Optional.empty(), Optional.empty())));
