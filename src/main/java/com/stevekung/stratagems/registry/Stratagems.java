...
public class Stratagems
{
    ...
    public static void bootstrap(BootstrapContext<Stratagem> context)
    {
        ...
        register(context, TNT, "wdsd", Items.TNT, SpawnBombAction.spawnBomb(), DepletedRule.defaultRule(), StratagemProperties.withReplenish(40, 60, 3, RED_COLOR, new StratagemReplenish(Optional.of(TNT_REARM), Optional.of(context.lookup(ModRegistries.STRATAGEM).getOrThrow(ModConstants.StratagemTag.TNT_REPLENISH)), Optional.empty())));
        register(context, FAST_TNT, "wdsw", new StratagemDisplay(StratagemDisplay.Type.ITEM, Optional.of(new ItemStack(Items.TNT)), Optional.empty(), Optional.empty(), false, Optional.of("F")), SpawnBombAction.spawnBomb(40), DepletedRule.defaultRule(), StratagemProperties.withReplenish(20, 30, 3, RED_COLOR, new StratagemReplenish(Optional.of(TNT_REARM), Optional.of(context.lookup(ModRegistries.STRATAGEM).getOrThrow(ModConstants.StratagemTag.TNT_REPLENISH)), Optional.empty())));
        register(context, LONG_TNT, "awdw", Items.TNT, SpawnBombAction.spawnBomb(100, Blocks.DIAMOND_BLOCK.defaultBlockState()), DepletedRule.defaultRule(), StratagemProperties.withReplenish(20, 30, 1, RED_COLOR, new StratagemReplenish(Optional.of(TNT_REARM), Optional.of(context.lookup(ModRegistries.STRATAGEM).getOrThrow(ModConstants.StratagemTag.TNT_REPLENISH)), Optional.empty())));
